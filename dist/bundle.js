...
;// CONCATENATED MODULE: ./src/listItemArray.js
let listItemArr = [];
...
;// CONCATENATED MODULE: ./src/listItemFactory.js
...
/* harmony default export */ const listItemFactory = (createListItem);
...
function createListItemFromFormInput() {
    ...
    form.addEventListener('submit', (e) => {
    	...
    	const newItem = listItemFactory(false, obj.title, obj.description, obj.dueDate, obj.priority, obj.projectGroup);
